<%-- 
    Document   : Update
    Created on : 07-Apr-2018, 12:34:19
    Author     : alilo
--%>
...
<html>
    ...
    <form class="well form-horizontal" Action="Update" method="post"  id="contact_form">
        ...
        <!-- Form Name -->
        <legend><center><h2>Update Client</h2></center></legend>
       
        <!-- Text input-->
        <p id="profile-name" class="profile-name-card" name="id"><c:out value="${client.id}"/></p>

        <div class="md-form">
            <input type="text"  name="nom" id="nom" class="form-control" value=" <c:out value="${client.nom}"/> " required>
            <label for="form1" >Nom</label>
        </div>

        <!-- Text input-->
        <div class="md-form">
            <input type="text" name="prenom" id="prenom" class="form-control" value="<c:out value="${client.prenom}"/>" required>
        ...
        <select class="mdb-select" id="nationalite" name="nationalite">
            <option   selected><c:out value="${client.getNationalite()}"/></option>
